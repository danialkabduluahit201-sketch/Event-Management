...
public class DatabaseOperations {
    ...
    public static void addFemaleParticipantToDB(Scanner sc) {
        ...
        FemaleParticipant f_p=new FemaleParticipant(firstName+lastName,age,email,tShirtSize);
        DataPool.addParticipant(f_p);
    ...
    public static void updateParticipant(Scanner sc) {
        ...
        System.out.println("How many columns to update?");
